...
class SpotifyObjectBase:
    ...
    @classmethod
    def load_from_json(cls, *, ignore_errors=True):
        ...
        try:
            ...
            print(f"Could not read '{json_path}'")
    ...
    @classmethod
    def use_json(cls, *, ignore_errors=True):
        cls.load_from_json(ignore_errors=ignore_errors)
